...
This file documents common repetitive tasks and workflows for maintaining the HN Code documentation site.
...
2. Follow the standard provider documentation template:
    ...
    - Configuration in HN Code section
...
# Using [Provider Name] With HN Code
