...
# Using Google Gemini With HN Code

HN Code supports Google's Gemini family of models through the Google AI Gemini API.
...
HN Code supports the following Gemini models:
