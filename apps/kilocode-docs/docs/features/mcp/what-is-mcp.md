...
HN Code implements the Model Context Protocol to:
...
- [Using MCP in HN Code](/features/mcp/using-mcp-in-kilo-code) - Get started with MCP in HN Code, including creating simple servers
