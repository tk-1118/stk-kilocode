...
Codebase Indexing enables semantic code search across your entire project using AI embeddings. Instead of searching for exact text matches, it understands the _meaning_ of your queries, helping HN Code find relevant code even when you don't know specific function names or file locations.
...
4. **Provides the [`codebase_search`](/advanced-usage/available-tools/codebase-search) tool** to HN Code for intelligent code discovery
...
- **Enhanced AI Understanding**: HN Code can better comprehend and work with your codebase
...
1. Open HN Code settings (<Codicon name="gear" /> icon)
...
Once indexed, HN Code can use the [`codebase_search`](/advanced-usage/available-tools/codebase-search) tool to find relevant code:
...
The tool provides HN Code with:
