---
sidebar_label: 安装HN Code
---

# 安装HN Code

HN Code是一款VS Code扩展，可将AI编程助手直接集成到编辑器中。可通过以下方式安装：
...
若已安装VS Code：[点击此处直接安装HN Code](vscode:extension/kilocode.Kilo-Code)
...
3. 搜索 "HN Code"
4. 选择HN Code发布的扩展并点击**安装**
5. 根据提示重新加载VS Code

安装完成后，在侧边栏找到HN Code图标（<img src="/docs/img/kilo-v1.svg" width="12" />）即可打开面板。

<img src="/docs/img/installing/installing.png" alt="VS Code应用商店中的HN Code扩展安装界面" width="400" />
*VS Code应用商店中的HN Code扩展安装界面*

## Cursor应用商店

:::tip

若已安装Cursor：[点击此处直接安装HN Code](cursor:extension/kilocode.Kilo-Code)
...
在VSCodium、Gitpod、Eclipse Theia、Windsurf等兼容编辑器中，可通过[Open VSX上的HN Code页面](https://open-vsx.org/extension/kilocode/Kilo-Code)直接安装。
...
1. **下载VSIX文件：**
    ...
    - 在[HN Code GitHub Releases页面](https://github.com/Kilo-Org/kilocode/releases)查找正式版本
