...
3. **创建密钥：** 点击 "Create API key" 并为您的密钥输入一个描述性名称（例如 "HN Code"）。
...
1. **打开 HN Code 设置：** 在 HN Code 面板中点击齿轮图标 (<Codicon name="gear" />)。
