...
build_extension() {
  echo "🔨 Building the HN Code extension..."
...
echo -n "🗄️ Syncing HN Code evals database... "
...
read -p "💻 Do you want to build a new version of the HN Code extension? [currently $current_version] (y/N): " build_extension
