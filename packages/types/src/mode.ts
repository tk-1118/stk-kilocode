...
export const MODE_ACTIVITY_DESCRIPTIONS: Record<string, string> = {
	...
	// 前端专业模式活动
	"fdev01-vue3ts-frontend-project-structure-coder-agent": "开始搭建Vue3+TS前端项目结构",
	"fdev02-vue3ts-component-coder-agent": "开始开发Vue3+TS组件",
	"fdev03-vue3ts-composable-coder-agent": "开始开发Vue3组合式函数",
	"fdev04-vue3ts-mockjs-service-coder-agent": "开始配置MockJS数据模拟服务",
	"fdev05-vue3ts-api-service-coder-agent": "开始开发API服务层",
	"fdev06-vue3ts-pinia-store-coder-agent": "开始配置Pinia状态管理",
	"fdev07-vue3ts-router-coder-agent": "开始配置Vue路由系统",
	"fdev08-vue3ts-frontend-testing-coder-agent": "开始编写前端测试代码",
	"fdev09-vue3ts-vite-build-coder-agent": "开始配置Vite构建系统",
	"fdev10-vue3ts-ui-design-system-coder-agent": "开始设计UI设计系统",
	"fdev11-vue3ts-i18n-coder-agent": "开始配置Vue国际化系统",
	"fdev12-vue3ts-observability-performance-coder-agent": "开始实现可观测与性能优化",
	"fdev13-vue3ts-frontend-security-coder-agent": "开始实施前端安全防护",
	"fdev14-vue3ts-page-coder-agent": "开始开发页面功能",
} as const
